  ...
  <body>
    ...
    <div class="main-container">
      ...
      <div class="main-contant">
        ...
        <div class="card-list">
          <div class="row">
            <div class="empty_notes">
                <p><i class='fa fa-bell-o' aria-hidden='true'></i> Notes is Empty</p>
            </div>
    ...
    function displayNotes(notes) {
        ...
        notes.forEach((note) => {
                            ...
                            <div class='main-containt'>
                                <div class='title'>
                                   ...
                                   <a href='../php/update?id=${note.id}&status=${note.status}'>
                                        <span class='pinned-note'><i class='fa fa-thumb-tack' aria-hidden='true'></i></span>
                                    </a>
                                </div>
                        ...
                        <div class='container' data-id='${note.id}' onclick='showDetails(this)'>
                            <div class='main-containt'>
                                <div class='title'>
                                    <p class='title_text' >${note.titles}</p>
                                   <a href='../php/update?id=${note.id}&status=${note.status}'>
                                        <span class='unpinned-note'><i class='fa fa-thumb-tack' aria-hidden='true'></i></span>
                                    </a>
                                </div>
                                <textarea style='user-select: none;' readonly>${note.messages}</textarea>
                            </div>
            ...
            if (note.status == "pinned") {
                $('.pn').show();
                $('.empty_notes').hide();
                pinnedNotesContainer.append(pinNotes);
            } else if (note.status == "unpinned") {
                $('.unpn').show();
                $('.empty_notes').hide();
                unpinnedNotesContainer.append(unpinNotes);
            }
        });
    }
...
function showDetails(note) {
    $.ajax({
        ...
        success: function (response) {
            ...
            if (noteId) {
              var botton_ic = `
                  <a href='../php/update?id=${id}&status=archive'><span class="footer_icon"><i class='bi bi-archive' aria-hidden='true'></i></span></a>
                  <a href='../php/update?id=${id}&status=trash'><span class="footer_icon"><i class='fa fa-trash-o' aria-hidden='true'></i></span></a>
                  <a href='../php/update?id=${id}&status=share'><span class="footer_icon"><i class='fa fa-share' aria-hidden='true'></i></span></a>
