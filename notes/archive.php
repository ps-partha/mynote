...
function showDetails(note) {
    $.ajax({
        ...
        success: function (response) {
            ...
            if (noteId) {
              var botton_ic = `
                 <a href='../php/update?id=${noteId}&status=unarchive'><span class="footer_icon"><i class='bi bi-archive' aria-hidden='true'></i></span></a>
                  <a href='../php/update?id=${noteId}&status=trash'><span class="footer_icon"><i class='fa fa-trash-o' aria-hidden='true'></i></span></a>
